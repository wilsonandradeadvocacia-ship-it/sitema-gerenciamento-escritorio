    ...
    <div className="min-h-screen flex">
      <aside className="no-print w-64 shrink-0 bg-brand-900 text-white flex flex-col">
        <div className="px-5 py-6 border-b border-white/10">
          ...
          {/* O Visto na posição de rubrica: pousado embaixo do nome. */}
          <Visto cut="master" height={13} className="text-white/80 mt-2" />
          <div className="text-xs text-brand-200 mt-2">Gestão &amp; Honorários</div>
        </div>
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                `block px-5 py-2.5 text-sm transition-colors ${
                  isActive
                    ? 'bg-brand-700 text-white font-medium border-r-4 border-grifo-500'
